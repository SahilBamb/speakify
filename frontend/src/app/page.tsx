      ...
      <nav className="glass-strong sticky top-0 z-50 shadow-sm shadow-black/[0.03]">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-semibold text-slate-800 tracking-tight">Speakify</span>
          </div>
          <Link
            href="/dashboard"
            className="px-5 py-2 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 text-white text-sm font-medium shadow-md shadow-indigo-200/50 hover:shadow-lg hover:shadow-indigo-300/50 hover:scale-[1.02] active:scale-[0.98] transition-all"
          >
            Open App
          </Link>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            <StepCard
              ...
              description="Drop a PDF or type a topic to generate a book with AI."
            />
            <StepCard
              number="02"
              title="Press Play"
              description="Hit play and listen. Every sentence highlights as it's spoken."
            />
            <StepCard
              number="03"
              title="Read Anywhere"
              description="Your progress is saved. Pick up exactly where you left off."
            />
          </div>
        </div>
      </section>
  ...
  return (
    <div className="glass rounded-2xl p-6 shadow-sm hover:shadow-md hover:shadow-indigo-100/30 hover:scale-[1.01] transition-all duration-300">
      <div className={`w-11 h-11 rounded-xl ${bgMap[color]} flex items-center justify-center mb-4`}>
        <svg className={`w-5 h-5 ${iconMap[color]}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          {icon}
        </svg>
      </div>
