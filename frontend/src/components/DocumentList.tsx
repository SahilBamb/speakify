          ...
          >
            <div className="flex items-center gap-4 min-w-0">
              <div className={`
                ...
                ${doc.status === "ready" ? "bg-zinc-50" : doc.status === "failed" ? "bg-rose-50" : "bg-amber-50"}
              `}>
                <svg className={`w-5 h-5 ${doc.status === "ready" ? "text-zinc-400" : doc.status === "failed" ? "text-rose-400" : "text-amber-400"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
