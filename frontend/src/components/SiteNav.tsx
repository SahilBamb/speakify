    ...
    <nav className="glass-strong sticky top-0 z-50 shadow-sm shadow-black/[0.03]">
      <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/dashboard"
            className="px-4 py-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-white text-sm font-medium shadow-sm shadow-zinc-200/40 hover:shadow-md hover:shadow-zinc-200/50 hover:scale-[1.02] active:scale-[0.98] transition-all"
          >
            Open App
          </Link>
        </div>
